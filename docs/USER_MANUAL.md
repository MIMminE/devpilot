...
PAS는 개발자가 하루 업무를 시작하고, Jira 일감과 저장소를 연결하고, Codex 작업 요청과 보고서 작성까지 이어갈 수 있도록 만든 macOS 로컬 업무 콘솔입니다.
...
![PAS 대시보드](assets/screenshots/pas-dashboard.png)
...
![PAS 작업 화면](assets/screenshots/pas-work.png)
...
![PAS 저장소 화면](assets/screenshots/pas-repositories.png)
...
![PAS 보고서 화면](assets/screenshots/pas-report.png)
...
![PAS 기록 화면](assets/screenshots/pas-records.png)
...
PAS는 단순한 TODO 앱이 아니라, 개발자의 실제 업무 흐름을 작은 자동화 단위로 연결한 앱입니다.
