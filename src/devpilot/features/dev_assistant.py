...
from devpilot.features.jira_daily import format_today_items, today_items_slack_blocks
from devpilot.features.repo_report import report
from devpilot.features.repo_status import collect_repo_status, format_repo_status
from devpilot.integrations.calendar import format_calendar, upcoming_events
...
from devpilot.integrations.slack import SlackClient, context_block, divider_block, fields_block, header_block, section_block
...
def _routine_blocks(title: str, message: str) -> list[dict]:
    ...
    blocks.append(context_block("DevPilot 개발자 루틴 보조"))
    return blocks[:50]
