...
from devpilot.app_state import default_report_agent_path
from devpilot.config import AppConfig
from devpilot.features.daily_activity import draft_daily_work_report
from devpilot.integrations.git_repos import configured_repositories, current_branch, git, recent_commits
from devpilot.integrations.jira import JiraClient
from devpilot.integrations.openai_report import build_report, generate_text, tone_instruction
